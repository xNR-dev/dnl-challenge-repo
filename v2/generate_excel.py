#!/usr/bin/env python3
"""Generate an Excel checklist from checklist.json (v2)."""
...
def main():
    ...
    # v2 metadata fields
    meta_fields = ["entity_type", "size_class", "reporting_framework", "pl_format", "applicable_date", "framework_version"]
    ...
    COLUMNS = [
        ...
        "HGB Reference", "Version Info", "Source URL",
        "Obligation", "Trigger Condition", "Completeness Prompt", "Audit Response"
    ]
    ...
    for sec in sections_order:
        ...
        # Column widths
        widths = [12, 10, 20, 50, 20, 22, 45, 12, 28, 50, 14]
